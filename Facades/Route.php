 ...
 * @method static \WPINT\Core\Foundation\Routing\WP\AdminRoute admin($path, $action = null)
 * @method static \WPINT\Core\Foundation\Routing\WP\AjaxRoute ajax($path, $action = null)
 * @method static \WPINT\Core\Foundation\Routing\WP\RestRoute rest($method, $path, $action = null)
 *
 * @see \WPINT\Core\Foundation\Routing
 */
